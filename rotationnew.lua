...
--// END LISENCE
            ...
            while true do
                ...
                if not nuked then
                    checkFire(world)
                    if not fired or take_firehose then
                        tt = os.time()
                        sleep(100)
                        if toxicwst then
